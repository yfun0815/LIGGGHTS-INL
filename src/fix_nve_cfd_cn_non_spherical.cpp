...
#include <stdio.h>
#include <string.h>
#include "fix_nve_cfd_cn_non_spherical.h"
#include "atom.h"
#include "atom_vec.h"
#include "update.h"
#include "respa.h"
...
FixNVECfdCnNonSpherical::FixNVECfdCnNonSpherical(LAMMPS *lmp, int narg, char **arg) :
    FixNVE(lmp, narg, arg),
    concave_(false),
    multisphere_(0),
...
FixNVECfdCnNonSpherical::~FixNVECfdCnNonSpherical()
{
...
void FixNVECfdCnNonSpherical::convexHullInit()
{
...
void FixNVECfdCnNonSpherical::init()
{
    FixNVE::init();
...
void FixNVECfdCnNonSpherical::dynamic_euler(double *wbody, double *tbody, double *inertia, double *result)
{
...
void FixNVECfdCnNonSpherical::integrate_dynamic_euler(double dt, double *wbody, double *tbody, double *inertia)
{
    double omega_der[3];
    double tol = 1e-12;
...
void FixNVECfdCnNonSpherical::integrate_quaternion(double *quat, double *wbody)
{
    double q2[4];
    q2[0] = 1.0;
    q2[1] = -wbody[0] * dtq;
...
void FixNVECfdCnNonSpherical::initial_integrate(int vflag)
{
...
/* ---------------------------------------------------------------------- */
void FixNVECfdCnNonSpherical::final_integrate()
{
...
void FixNVECfdCnNonSpherical::initial_integrate_single(int vflag)
{
    double **x = atom->x;
    double **v = atom->v;
    double **f = atom->f;
...
void FixNVECfdCnNonSpherical::implicitVelocityUpdate
            (
...
void FixNVECfdCnNonSpherical::final_integrate_single()
{
    double **v = atom->v;
    double **f = atom->f;
    double **omega = atom->omega;
...
void FixNVECfdCnNonSpherical::initial_integrate_clump(int vflag)
{
...
void FixNVECfdCnNonSpherical::final_integrate_clump()
{
    double *const *const vcm = multisphere_->get_vcm_ptr();
    double *const *const fcm = multisphere_->get_fcm_ptr();
    double *const *const torquecm = multisphere_->get_torquecm_ptr();
...
int FixNVECfdCnNonSpherical::setmask()
{
...
void FixNVECfdCnNonSpherical::setup(int dummy)
{
...
void FixNVECfdCnNonSpherical::pre_final_integrate()
{
    if(integrate_convexhull) modify_body_forces_torques();
}

void FixNVECfdCnNonSpherical::modify_body_forces_torques()
{
...
void FixNVECfdCnNonSpherical::reset_dt()
{
    dtv = update->dt;
...
void FixNVECfdCnNonSpherical::richardson_initial_integrate(double dtf, double *angmom, double *omega, double *torque, double *quat, double *inertia,
...
void FixNVECfdCnNonSpherical::richardson_final_integrate(double dt, double *angmom, double *omega, double *torque,  double *quat, double *inertia,
                                  bool *tflag, double *ex_space, double *ey_space, double *ez_space)
{
    if(tflag[0])
...
void FixNVECfdCnNonSpherical::symplectic_initial_integrate(double dtf2, double *angmom, double *quat, double *omega, double *torque, double *inertia)
{
...
void FixNVECfdCnNonSpherical::symplectic_final_integrate(double dtf2, double *angmom, double *quat, double *omega, double *torque, double *inertia)
{
    double tbody[3], rotation_matrix[9];
...
void FixNVECfdCnNonSpherical::predictor_corrector_initial_integrate(double dtf, double *angmom, double *quat, double *omega, double *torque, double *inertia)
{
...
void FixNVECfdCnNonSpherical::predictor_corrector_final_integrate(double dtf, double *angmom, double *quat, double *omega, double *torque, double *inertia)
{
    double rotation_matrix[9];
    double mbody[3], wbody[3], tbody[3];
    MathExtraLiggghtsNonspherical::quat_to_mat(quat, rotation_matrix); //calculate rotation matrix from quaternion
...
void FixNVECfdCnNonSpherical::woodem_initial_integrate(double dtf2, double *angmom, double *quat, double *omega, double *torque, double *inertia)
{

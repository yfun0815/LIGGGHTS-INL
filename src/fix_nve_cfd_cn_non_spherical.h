...
FixStyle(nve/cfd_cn/nonspherical,FixNVECfdCnNonSpherical)
FixStyle(nve/cfd_cn/convexhull,FixNVECfdCnNonSpherical)
FixStyle(nve/cfd_cn/superquadric,FixNVECfdCnNonSpherical)

#else

#ifndef LMP_FIX_NVE_CFD_CN_NONSPHE_BASE_H
#define LMP_FIX_NVE_CFD_CN_NONSPHE_BASE_H
...
class FixNVECfdCnNonSpherical : public FixNVE {
 public:
  FixNVECfdCnNonSpherical(class LAMMPS *, int, char **);
  virtual ~FixNVECfdCnNonSpherical();
  virtual void init();
  virtual void initial_integrate(int);
  void initial_integrate_clump(int);
  void initial_integrate_single(int);
  void implicitVelocityUpdate(double dtf, double rmass, double particleDensity, double *v, double *f, double *Ksl, double *uf, double *frc);
